    ...
    <section id="home" className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden pt-24 pb-12 md:pt-20 md:pb-0">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
            <div className="max-w-5xl mx-auto space-y-4 md:space-y-6">
                ...
                {/* Availability Badge */}
                <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-blue-500/5 border border-blue-500/20 backdrop-blur-md animate-fade-in-up transition-all hover:bg-blue-500/10 cursor-default shadow-[0_0_15px_rgba(59,130,246,0.1)] mt-4 md:mt-6 mb-0">
                ...
                {/* Main Headline */}
                <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight leading-[1.1] md:leading-[1.15] text-[var(--text-primary)] animate-fade-in-up animation-delay-100 drop-shadow-xl">
                ...
                {/* Dynamic Subtitle */}
                <div className="h-12 md:h-12 animate-fade-in-up animation-delay-200 flex items-center justify-center">
                ...
                {/* Description */}
                <p className="text-[var(--text-secondary)] text-base sm:text-lg max-w-2xl mx-auto leading-relaxed animate-fade-in-up animation-delay-300 px-2 md:px-4 font-light opacity-90">
                  {t('hero_description')}
                </p>

                {/* Action Buttons */}
                <div className="flex flex-row items-center justify-center gap-3 md:gap-5 mt-8 md:mt-10 animate-fade-in-up animation-delay-500 w-full px-4 sm:px-0 max-w-md sm:max-w-none mx-auto">
                    <a 
                      href="#experience" 
                      onClick={(e) => handleScrollTo(e, 'experience')}
                      className="flex-1 sm:flex-none sm:w-auto px-6 py-3 md:px-10 md:py-4 rounded-xl bg-blue-600 text-white font-semibold text-base md:text-lg shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:-translate-y-1 transition-all duration-300 text-center flex items-center justify-center gap-2"
                    >
                    ...
                    <a 
                      ...
                      className="flex-1 sm:flex-none sm:w-auto px-6 py-3 md:px-10 md:py-4 rounded-xl border border-[var(--border-color)] bg-[var(--bg-secondary)] text-[var(--text-primary)] font-semibold text-base md:text-lg hover:border-blue-500/50 hover:bg-[var(--bg-tertiary)] hover:-translate-y-1 transition-all duration-300 text-center flex items-center justify-center gap-2"
                    >
                ...
                <div className="pt-10 md:pt-14 flex justify-center animate-fade-in-up animation-delay-700">
                    <a 
                      href="#about" 
